...
import { X, MapPin, MessageSquare, Share2, ShieldCheck, Clock, CheckCircle, ChevronDown, ArrowLeft, AlertTriangle, Maximize2, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function PropertyInspector({ property, onClose }: PropertyInspectorProps) {
  ...
  // --- IMAGE GALLERY LOGIC ---
  // Combine cover image and any additional images into a clean array
  const galleryImages = useMemo(() => {
    ...
    // 2. Add other images (handling different potential data structures from DB)
      ...
      <AnimatePresence>
        {isImageExpanded && (
          ...
          >
            ...
            {/* Expanded Image */}
            <motion.img 
              key={photoIndex} // Trigger animation on change
